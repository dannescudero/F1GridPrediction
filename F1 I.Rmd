...
for (i in 1:n){
  ...
  for (j in 1:20){
    ...
    if(round == 1 | driver == "kubica" & round == 13){ #| driver == "vettel" & round == 3 ##ADJUSTMENT FOR DRIVERS THAT DID NOT RACED COMPLETE SEASON (driver + first participation race) #driver == "vettel" & round == 3 | driver == "de_vries"
...
#colnames(masterDataSet2019)[7] <- "pos_gained" #changing name of column
...
##### 1- First grid
min_parameters <- expand.grid("a" = seq(0, 1, by = 0.25), "b" = seq(0, 1, by = 0.25),
                              "c" = seq(0, 1, by = 0.25), "d" = seq(0, 1, by = 0.25),
                              "e" = seq(0, 1, by = 0.25))
