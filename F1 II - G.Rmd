...
# Master DATASET
View(cbind.data.frame(Results_DF[,c(1,2,7,4,3,5)], as.numeric(Results_DF[,4]) - as.numeric(Results_DF[,3]), drivers_const_DF[,c(3,4)], F1PI_DF[,c(4,5)]))
...
legend("topright", legend = c("Combinations","Minimum MSE","Optimum"), col = c("springgreen3","orangered3","dodgerblue4"),bty="n",cex=0.9,lwd = 3,lty=c(1,2,0),pch = c(-1, -1, 4))
